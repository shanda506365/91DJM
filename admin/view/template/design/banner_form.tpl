...
function addImage() {
	...
	<?php } ?>
	html += '  </td>';
  html += '  <td class="text-left"><textarea style="width: 300px;height:80px;" name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][description]" placeholder="描述" class="form-control"></textarea></td>';
	...
	html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '" data-toggle="image" directory="ad" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="banner_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
