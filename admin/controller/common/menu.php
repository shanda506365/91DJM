...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['factory'] = $this->url->link('catalog/factory', 'token=' . $this->session->data['token'], 'SSL');//新增积木工厂
        $data['case'] = $this->url->link('catalog/case', 'token=' . $this->session->data['token'], 'SSL');//新增案例展示
